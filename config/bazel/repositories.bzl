...
def _py_repositories():
    ...
    http_archive(
        ...
        sha256 = "4a99b93f58c30730da5ecd771c204605aba81be1d5d5b41c4f697b1fea30f92b",
        strip_prefix = "typeshed-e4c2c0f3021abac1078854da92a9ec14848b32f4",
        urls = [
            "https://github.com/python/typeshed/archive/e4c2c0f3021abac1078854da92a9ec14848b32f4.tar.gz",
        ],
    )
    http_archive(
        name = "dm_rlax",
...
def research_repositories():
    ...
    http_archive(
        ...
        patch_args = ["-p1"],
        sha256 = "854fb864a5c98c09dd1023bbcbbaeeace5f48622fb69c4146657acc76ad67c93",
        strip_prefix = "dbx_build_tools-4b06fd2f7ff29885bc8858c4e4bf485c76d8fc07",
        urls = ["https://github.com/dropbox/dbx_build_tools/archive/4b06fd2f7ff29885bc8858c4e4bf485c76d8fc07.tar.gz"],
    )
